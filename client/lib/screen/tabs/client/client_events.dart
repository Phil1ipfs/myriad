...
class ClientEvents extends StatefulWidget {
  const ClientEvents({super.key});

  @override
  State<ClientEvents> createState() => _ClientEventsState();
}

class _ClientEventsState extends State<ClientEvents> {
  ...
  void showEventSlideUp(int index) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          '${event['registered'] ?? 0} people registered',
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return GestureDetector(
                                  onTap: () =>
                                      showEventSlideUp(events.indexOf(event)),
                                  child: Card(
